...
<body style="background-color: lavender">
	...
	<form action="gsearch.php" method="post">
		<div>Enter Gallery ID:<input type="text" name="G_ID" placeholder="G_ID 100-106"><br></div>
		<br><br>
...
<p style="font-family: arial"><a href="gallery.html"><font style="color:black">GO BACK</font></a></p>
</html>