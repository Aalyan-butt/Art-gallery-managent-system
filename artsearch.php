...
<body style="background-color: aliceblue">
    ...
    <form action="artsearch.php" method="post">
        <div>Enter Artwork ID:<input type="text" name="artid" placeholder="Artwork_ID 300-306 "><br></div>
        <br><br>
...
<h5 style="font-family: arial"><a href="artwork.html"><font style="color:black">GO BACK</font></a></h5>
</html>