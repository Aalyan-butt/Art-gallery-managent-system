...
<body style="background-color: lavenderblush">
	...
	<form action="edelete.php" method="POST">
		<div>Enter Exhibition ID:<input type="text" name="E_ID" placeholder="E_ID 200-206"><br></div>
		<br><br>
...
<p style="font-family: arial"><a href="exhibition.html"><font style="color:black">GO BACK</font></a></p>
</html>
