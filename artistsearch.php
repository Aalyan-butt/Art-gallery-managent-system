...
<body style="background-color: lavender">
	...
	<form action="artistsearch.php" method="post">
		<div>Enter Artist ID:<input type="text" name="artistid" placeholder="Artist_ID 500-506"><br></div>
		<br><br>
...
<p style="font-family: arial"><a href="artist.html"><font style="color:black">GO BACK</font></a></p>
</html>